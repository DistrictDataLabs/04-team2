...
summarize_app = Blueprint('summarize_app',__name__)
...
@summarize_app.route('/api/tasks', methods=['GET'])
def get_tasks():
    return jsonify({'tasks': tasks})

@summarize_app.route('/api/strings/<string:patent>', methods=['GET'])
def get_summary(patent):
    return jsonify({'summary': 'hello ' + patent})

@summarize_app.route('/api/patent/<string:id>', methods=['GET'])
def get_patent(id):
